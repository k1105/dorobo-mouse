    ...
    this.root.innerHTML = `
      <div class="lobby-panel wide">
        ...
        <div class="controls-help">
          ...
          <p>🎥 猫: 店内カメラ12台をボタン or 数字キーでオンライン⇔オフライン切替（同時${CONFIG.maxViewCams}台まで）。映像内の怪しいネズミをクリックでダウト（1ラウンド各${CONFIG.doubtsPerRound}回まで）。的中したネズミは商品を没収されて死角にリスポーン、NPCなら空振り。ラウンドは時間切れで終了</p>
          <p>💡 オンラインのカメラは球体が赤く発光し、視野に入っている床が明るくなる（ネズミからも「みられている場所」が分かる）</p>
          <p>🐱 猫: Mキーでカメラマップ（視野と死角の俯瞰図）をモーダル表示。🐭 ネズミは同じマップが左下に常時表示され、自分の位置が分かる</p>
